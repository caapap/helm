...
*/}}
{{- define "stellar.name" -}}
{{- default "stellar" .Values.nameOverride | trunc 63 | trimSuffix "-" -}}
{{- end -}}
...
{{- define "stellar.stellar.host" -}}
  {{- if eq .Values.stellar.type "internal" -}}
    {{- template "stellar.stellar" . }}
  {{- else -}}
    {{- .Values.stellar.external.host -}}
  {{- end -}}
{{- end -}}


{{- define "stellar.stellar.port" -}}
  {{- if eq .Values.stellar.type "internal" -}}
    {{- printf "%s" "17000" -}}
  {{- else -}}
    {{- .Values.stellar.external.port -}}
  {{- end -}}
{{- end -}}

{{- define "stellar.stellar.servicePort" -}}
    {{- printf "80" -}}
{{- end -}}
...
{{- define "stellar.categraf" -}}
  {{- printf "%s-categraf" (include "stellar.fullname" .) -}}
{{- end -}}

{{- define "stellar.stellar" -}}
